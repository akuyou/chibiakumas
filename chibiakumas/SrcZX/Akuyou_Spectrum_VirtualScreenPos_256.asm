...
ShowSpriteReconfigure:
	...
	cp 9 ;72px
	jp z,ShowSpriteReconfigure_72px
	cp 10;20 ;80px
	...
	cp 5
	jr z,ShowSpriteReconfigure_40px
ret
...
ShowSpriteReconfigure_16px:
	...
	jr ShowSpriteReconfigure_all
ShowSpriteReconfigure_40px:
	ld a,VScreen_MaxX-20
	ld b,VScreen_MaxY-40
	jr ShowSpriteReconfigure_all
